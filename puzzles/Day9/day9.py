...
def find_unsummed_nr(numbers, past_n_to_check):
    sums_with_previous = [set() for _ in range(len(numbers))]
...
def find_summing_sequence(numbers, n):
    start, end = 0, 1
...
def part2():
    seq = find_summing_sequence(read_input_as_numbers(), 18272118)
